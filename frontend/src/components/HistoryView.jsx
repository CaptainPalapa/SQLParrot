...
const HistoryView = () => {
  ...
  const formatOperationDescription = (operation) => {
    ...
    switch (operation.type) {
      case 'create_group':
        return `Created group "${getProperty('groupName')}" with ${getProperty('databaseCount')} databases`;
      case 'update_group':
        return `Updated group "${getProperty('groupName')}" with ${getProperty('databaseCount')} databases`;
      case 'delete_group':
        return `Deleted group "${getProperty('groupName')}"`;
      case 'create_snapshots': {
